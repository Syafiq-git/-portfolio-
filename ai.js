...
const faqData = [{
    ...
    response: "Frontend developer berfokus pada pengembangan bagian depan aplikasi web yang berinteraksi langsung dengan pengguna, menggunakan HTML, CSS, dan JavaScript, dan saya masih belajar di bidang frontend developer."
}, {
    ...
    keywords: ["lahir", "tanggal lahir"],
    response: "saya lahir pada 14 januari 2009 di Jakarta"
}, {
    keywords: ["gombal"],
    ...
    response: "saya membuka jasa website dengan harga mulai dari 449.000 - 1.500.000 untuk info selanjutnya silahkan kunjungi halaman contact saya."
}, {
